...
**Live demo:** https://ci.stopthepwnage.com/
...
- A clean editorial aesthetic suited to a program-focused landing page
...
Demo is live and stable as of April 2026. Pending feedback from the CyberInspire team. Hosted on AWS Amplify (auto-deploy on push to `main`) with Cloudflare DNS.
